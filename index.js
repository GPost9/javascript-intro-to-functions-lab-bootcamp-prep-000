...
function sayHiToGrandma(string){return "I can't hear you" if logWhisper('Hello'), return "YES INDEED!" if logShout('HELLO!'), return "I love you, too." if console.log("I love you, Grandma")}