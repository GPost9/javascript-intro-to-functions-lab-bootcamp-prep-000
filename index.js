...
function sayHiToGrandma(string){return "I can't hear you" if logWhisper('Hello'), "YES INDEED!" if logShout('Hello'), "I love you, too." if console.log("I love you, Grandma.")}